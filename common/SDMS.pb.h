...
#ifndef GOOGLE_PROTOBUF_INCLUDED_common_2fSDMS_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_common_2fSDMS_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_common_2fSDMS_2eproto
...
struct TableStruct_common_2fSDMS_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_common_2fSDMS_2eproto;
namespace SDMS {
class ACLRule;
...
extern const uint32_t AccessTokenType_internal_data_[];
constexpr AccessTokenType AccessTokenType_MIN = static_cast<AccessTokenType>(1);
constexpr AccessTokenType AccessTokenType_MAX = static_cast<AccessTokenType>(255);
constexpr int AccessTokenType_ARRAYSIZE = 255 + 1;
const ::google::protobuf::EnumDescriptor*
AccessTokenType_descriptor();
template <typename T>
const std::string& AccessTokenType_Name(T value) {
  static_assert(std::is_same<T, AccessTokenType>::value ||
                    std::is_integral<T>::value,
                "Incorrect type passed to AccessTokenType_Name().");
  return ::google::protobuf::internal::NameOfEnum(AccessTokenType_descriptor(), value);
}
inline bool AccessTokenType_Parse(absl::string_view name, AccessTokenType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<AccessTokenType>(
      AccessTokenType_descriptor(), name, value);
}
enum NoteType : int {
  NOTE_QUESTION = 0,
  NOTE_INFO = 1,
...
class TopicData final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_common_2fSDMS_2eproto;
};// -------------------------------------------------------------------
...
template <>
struct is_proto_enum<::SDMS::AccessTokenType> : std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor<::SDMS::AccessTokenType>() {
  return ::SDMS::AccessTokenType_descriptor();
}
template <>
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_common_2fSDMS_2eproto_2epb_2eh

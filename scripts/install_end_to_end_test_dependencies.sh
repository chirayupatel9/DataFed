...
packages=("libtool" "build-essential" "g++" "gcc" "make" "pkg-config" "autoconf" "automake" "unzip" "libcurl4-openssl-dev" "wget"
	"rapidjson-dev" "libkrb5-dev" "git" "libssl-dev")

	
pip_packages=("setuptools")
# NOTE the order matters here
externals=("cmake" "boost" "libopenssl" "python" "protobuf" "nvm" "node" "foxx")
